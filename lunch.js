...
const whatToDoForLunch = function(hungry, availableTime) {
  ...
  let reply = '';
  if (!hungry) reply = 'Wait until you are hungry!';
  else {
    if (availableTime < 20)
      reply = 'Pick up a snack or grab something you have ready at home!';
    else if (availableTime >= 20 && availableTime <= 30)
      reply = 'You deserve a break and should take time to cook a tasty meal :)';
